...
import { MovieService } from './services/movie-servs.service';
@Component({
  selector: 'app-root',
...
ngOnInit(): void {
  this.subs.push(this.movie.getTrendingMovies().subscribe({next:data=>
    {this.trending=data;this.headerBGUrl='https://image.tmdb.org/t/p/original'+this.trending.results[3].backdrop_path}
 }))
